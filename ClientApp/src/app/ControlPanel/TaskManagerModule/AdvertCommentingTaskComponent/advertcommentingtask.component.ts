...
@Component({
    selector: 'advert-commenting-task',
    templateUrl: 'advertcommentingtask.component.html'
})

export class AdvertCommentingTaskComponent implements OnInit {
    taskName: string;
    ...
    public async AddTask() {
        var newTask = new AddAdvertCommentingTaskDTO();
...
export class AddAdvertCommentingTaskDTO {
    TaskName: string;
    AccountGroup: string;
    ProxyGroup: string;
